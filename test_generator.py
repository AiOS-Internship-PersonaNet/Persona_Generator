Private Convo Generator:
Testing with this code:
from langchain.chains import LLMChain
from langchain.llms import OpenAI
from langchain.prompts import PromptTemplate
persona1=  """The analyzed persona is someone who is thoughtful and considerate when making decisions.
...
template = """ Given the two user's personas , persona number 1:{persona1}//
...
"""
prompt = PromptTemplate(template=template, input_variables=["persona1", "persona2"])
llm_chain = LLMChain(prompt=prompt, llm=OpenAI(temperature=0.4,openai_api_key="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"))
x= llm_chain.predict(persona1=first, persona2=second)
print(x)